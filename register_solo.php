 ...
 <!-- Navigation -->
  ...
  <li><a data-toggle="modal" data-target=".bs-example-modal-lg" style="color:white; ">EVENTS SCHEDULE</a></li>
     ...
     <div class="container page-header">
                <h1>Registration  <small>Solo Events</small></h1>
    </div>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <form action="save_solo.php" method="POST" class="form-horizontal col-sm-12" role="form">
                            <div class="form-group">
                                <label for="name" class="control-label col-md-2 col-sm-2">Full Name</label>
                                <div class="col-md-6 col-sm-10">
                                    <input required type="text" id="name" name="name" class="form-control"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label for="usn" class="control-label col-md-2 col-sm-2">USN</label>
                                <div class="col-md-6  col-sm-10">
                                    <input required type="text" id="usn" name="usn" class="form-control"/>
                                </div>
                            </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="dep" class="control-label col-md-2 col-sm-2">Department</label>
                                <div class="col-md-6 col-sm-10">
                             ...
                             <div class="form-group">
                                <label for="sem"class="control-label col-md-2 col-sm-2">Semester</label>
                                <div class="col-md-6 col-sm-10">
                              ...
                              <div class="form-group">
                                <label for="sec"class="control-label col-md-2 col-sm-2">Section</label>
                                <div class="col-md-6 col-sm-10">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <select onChange="swapImage()" class="form-control" id="event" name="event" style="max-height:100px; overflow:auto;" >
