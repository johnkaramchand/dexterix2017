        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer">
                    ...
                    <form action="save_makeathon_solo.php" method="POST" class="form-horizontal col-sm-12" role="form">

<div class="form-group">
                            <label id="req" for="name1" class="control-label col-md-2 col-sm-2" >Full Name</label>
                        ...
                        <div class="form-group">
                                <label id="req" class="control-label col-md-2 col-sm-2" for="city">Event</label>
                                <div class="col-md-6 col-sm-10">
                                     <select class="form-control" id="event" name="event" >
                                            <option value="inter1">Makeathon</option>                                  
                                    </select>
