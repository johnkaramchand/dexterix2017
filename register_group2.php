   ...
   <!-- Paytm Modal -->
         <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <img  style="width:400px; width:400px;"id="imageToSwap" src="" alt="Select Event" />
       ...
       <div class="container page-header">
                <h1>Registration  <small>Team of two</small></h1>
        </div>
                    <form action="save_group2.php" method="POST"class="form-horizontal col-sm-12"  role="form">
                            <!-- Nav tabs -->
                            ...
                            <div class="form-group">
                             ...
                             <div class="col-md-offset-2 col-sm-offset-2 "  >
                                   ...
                                   <p><b>Amount to be paid: </b>₹60 </p>
                                <p> ₹30 per participant. But payment must be made together as ₹60.  </p>
